...
// Custom Keycode
#define KC_MOD_MIN KC_LCTL
#define KC_MOD_MAX KC_RGUI
...
#define C(keycode) (((uint16_t)BIT_LCTL<<8)|(uint16_t)keycode)
#define S(keycode) (((uint16_t)BIT_LSFT<<8)|(uint16_t)keycode)
#define A(keycode) (((uint16_t)BIT_LALT<<8)|(uint16_t)keycode)
#define G(keycode) (((uint16_t)BIT_LGUI<<8)|(uint16_t)keycode)

#define KC_MODIED_MIN C(0)
#define KC_MODIED_MAX A(S(C(G(0xFF))))

#define IS_CTLED(keycode) ((KC_MODIED_MIN<=keycode && KC_MODIED_MAX>=keycode)&&(keycode>>8&BIT_LCTL))
#define IS_SFTED(keycode) ((KC_MODIED_MIN<=keycode && KC_MODIED_MAX>=keycode)&&(keycode>>8&BIT_LSFT))
#define IS_ALTED(keycode) ((KC_MODIED_MIN<=keycode && KC_MODIED_MAX>=keycode)&&(keycode>>8&BIT_LALT))
#define IS_GUIED(keycode) ((KC_MODIED_MIN<=keycode && KC_MODIED_MAX>=keycode)&&(keycode>>8&BIT_LGUI))
#define IS_MODIED(keycode) ((KC_MODIED_MIN<=keycode && KC_MODIED_MAX>=keycode)&&(keycode>>8))
...
#define GPIOA0_0   KC_N
#define GPIOA1_0   KC_M
#define GPIOA2_0   KC_COMM
#define GPIOA3_0   KC_DOT
#define GPIOA4_0   KC_SLSH
#define GPIOA5_0   KC_H
#define GPIOA6_0   KC_J
#define GPIOA7_0   KC_K
#define GPIOA8_0   0
#define GPIOA9_0   0
#define GPIOA10_0  0
#define GPIOA11_0  0
#define GPIOA12_0  0
#define GPIOA13_0  KC_T
#define GPIOA14_0  KC_R
#define GPIOA15_0  KC_E

#define GPIOB0_0   KC_L
#define GPIOB1_0   KC_SCLN
#define GPIOB2_0   KC_P
#define GPIOB3_0   KC_W
#define GPIOB4_0   KC_Q
#define GPIOB5_0   KC_A
#define GPIOB6_0   KC_S
#define GPIOB7_0   KC_G
#define GPIOB8_0   KC_F
#define GPIOB9_0   KC_D
#define GPIOB10_0  KC_O
#define GPIOB11_0  KC_I
#define GPIOB12_0  KC_U
#define GPIOB13_0  KC_Y
#define GPIOB14_0  0
#define GPIOB15_0  0
...
#define GPIOC11_0  0
#define GPIOC12_0  0
#define GPIOC13_0  KC_Z
#define GPIOC14_0  KC_X
#define GPIOC15_0  KC_C
...
#define GPIOF0_0   KC_V
#define GPIOF1_0   KC_B
#define GPIOF2_0   0
#define GPIOF3_0   0
#define GPIOF4_0   0
#define GPIOF5_0   0
...
#define GPIOA0_1   KC_N
#define GPIOA1_1   KC_M
#define GPIOA2_1   KC_COMM
#define GPIOA3_1   KC_DOT
#define GPIOA4_1   KC_SLSH
#define GPIOA5_1   KC_H
#define GPIOA6_1   KC_J
#define GPIOA7_1   KC_K
#define GPIOA8_1   0
#define GPIOA9_1   0
#define GPIOA10_1  0
#define GPIOA11_1  0
#define GPIOA12_1  0
#define GPIOA13_1  KC_T
#define GPIOA14_1  KC_R
#define GPIOA15_1  KC_E

#define GPIOB0_1   KC_L
#define GPIOB1_1   KC_SCLN
#define GPIOB2_1   KC_P
#define GPIOB3_1   KC_W
#define GPIOB4_1   KC_Q
#define GPIOB5_1   KC_A
#define GPIOB6_1   KC_S
#define GPIOB7_1   KC_G
#define GPIOB8_1   KC_F
#define GPIOB9_1   KC_D
#define GPIOB10_1  KC_O
#define GPIOB11_1  KC_I
#define GPIOB12_1  KC_U
#define GPIOB13_1  KC_Y
#define GPIOB14_1  0
#define GPIOB15_1  0
...
#define GPIOC11_1  0
#define GPIOC12_1  0
#define GPIOC13_1  KC_Z
#define GPIOC14_1  KC_X
#define GPIOC15_1  KC_C
...
#define GPIOF0_1   KC_V
#define GPIOF1_1   KC_B
#define GPIOF2_1   0
#define GPIOF3_1   0
#define GPIOF4_1   0
#define GPIOF5_1   0
